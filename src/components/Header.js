...
export default class Header extends React.Component {
    ...
    renderNavLinks(navLinks, currentPageUrl, navBarTextColor, navBarTextColorActive) {
        return (
            <React.Fragment>
                <nav id="main-navigation" className="site-navigation" aria-label="Main Navigation" style={{backgroundColor: `coral`, color: navBarTextColor, color: navBarTextColorActive}}>
    ...
    render() {
        ...
        let navBarTextColorActive = _.get(header, 'navBarTextColorActive');

        return (
            <header id="masthead" className="site-header outer" style={{backgroundColor: navBarBackgroundColor}}>
                <div className="inner">
                    <div className="site-header-inside">
                        <div className="site-branding" style={{order: 0, color: `pink !important`}}>
                            {logoImage && (
                        ...
                        {!hideNavLinks && !_.isEmpty(navLinks) && this.renderNavLinks(navLinks, currentPageUrl, navBarTextColor, navBarTextColorActive)}
                    </div>
                </div>
            </header>
        );
