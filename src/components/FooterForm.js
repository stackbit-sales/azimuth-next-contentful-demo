...
export default function FooterForm(props) {
    ...
    return (
        <section className="cell widget widget-form">
            ...
            <div className="footer-form-text-color" style={{color: textColor}}>
            ...
            >
                ...
                {submitLabel && (
                    <div className="form-row">
                        <button type="submit" className="button submit-button-background-color submit-button-border-color submit-button-text-color submit-button-border-radius"style={{backgroundColor: submitButtonBackgroundColor, borderColor: buttonBorderColor, borderRadius: buttonBorderRadius, color: buttonTextColor }}>
                            {submitLabel}
                        </button>
                    </div>
                )}
