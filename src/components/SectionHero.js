...
export default function SectionHero(props) {
    ...
    return (
        <section id={sectionId} className={`block hero-block bg-accent outer`} style={{background: -webkit-gradient(linear, left top, right top, from(var(--background-color-left)), to(var(--background-color-right)))}}>
            <div className="inner">
