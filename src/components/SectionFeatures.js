...
export default function SectionFeatures(props) {
    ...
    const featuresBackgroundColor = _.get(section, 'featuresBackgroundColor');
    console.log(featuresBackgroundColor);
...
function FeatureItem(featureItem) {
    ...
    return (
        <div className="block-item">
            ...
            <style global jsx>{`
                    :root {
                        --features-background-color: ${featuresBackgroundColor};
                    };
            `}</style>
        </div>
    );
